...
def fetch_random_h3_and_below_content(base_url, category_path):
    # Complete URL
    ...
    if h2_tag:
        ...
        if h3_elements:
            ...
            return "No h3 elements found under specified h2.", article_url, title
    else:
        return "No h2 element with the specified IDs found.", article_url, title

# Example usage
base_url = 'https://wikip.co'
category_path = '/categories/natural-healing/'
h3_content, url, title = fetch_random_h3_and_below_content(base_url, category_path)
print(title, ":", url)
print(h3_content)
